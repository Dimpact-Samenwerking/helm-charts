...
[`4.6.8-to-4.7.6-upgrade.md`](4.6.8-to-4.7.6-upgrade.md)), then follow
this guide.
...
[`4.7.6-to-4.8.0-values-deltas.md`](4.7.6-to-4.8.0-values-deltas.md).
...
### B. Edit the gemeente `podiumd.yml` ([key-by-key reference](4.7.6-to-4.8.0-values-deltas.md))
...
- [ ] Remove image-tag overrides that merely repeat old chart defaults
      ([cleanup table](4.7.6-to-4.8.0-values-deltas.md#cleanup--image-tag-overrides)).
