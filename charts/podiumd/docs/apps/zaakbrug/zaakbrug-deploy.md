...
> `docs/_upgrade_paths/4.7.1-to-4.7.2-upgrade.md` for the original change. This document
...
- `docs/_upgrade_paths/4.7.1-to-4.7.2-upgrade.md` — original sub-chart introduction.
