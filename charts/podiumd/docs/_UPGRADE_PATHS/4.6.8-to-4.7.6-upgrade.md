...
> [`_UPGRADING.md`](../_UPGRADING.md) for the full upgrade path. Granular per-release
...
> [4.7.3→4.7.4](4.7.3-to-4.7.4-upgrade.md).
>
...
Full operator docs: [`charts/mi-data/docs/mi-exports.md`](../../../mi-data/docs/mi-exports.md).
...
- [`4.6.5-to-4.7.0-values-deltas.md`](4.6.5-to-4.7.0-values-deltas.md) — full table of values to add/change/remove for the 4.7.0 jump.
- Granular per-release notes: [4.7.0→4.7.1](4.7.0-to-4.7.1-upgrade.md), [4.7.1→4.7.2](4.7.1-to-4.7.2-upgrade.md), [4.7.2→4.7.3](4.7.2-to-4.7.3-upgrade.md), [4.7.3→4.7.4](4.7.3-to-4.7.4-upgrade.md).
- Next hop: [`4.7.8-to-4.8.0-upgrade.md`](4.7.8-to-4.8.0-upgrade.md).
