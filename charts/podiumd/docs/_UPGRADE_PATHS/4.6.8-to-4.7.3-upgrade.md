...
> [`_UPGRADING.md`](../_UPGRADING.md) for the full upgrade path. The granular
> per-release notes are kept alongside for reference:
> [4.7.0→4.7.1](4.7.0-to-4.7.1-upgrade.md),
> [4.7.1→4.7.2](4.7.1-to-4.7.2-upgrade.md),
> [4.7.2→4.7.3](4.7.2-to-4.7.3-upgrade.md).
>
