...
> [`_UPGRADING.md`](../_UPGRADING.md) for the full upgrade path. If you prefer
> smaller hops, do [4.6.6 → 4.6.8](4.6.6-to-4.6.8-upgrade.md) then
> [4.6.8 → 4.7.3](4.6.8-to-4.7.3-upgrade.md) — this guide is the union of
> the two.
>
...
Full operator documentation: [`charts/mi-data/docs/mi-exports.md`](../../../mi-data/docs/mi-exports.md).
...
3. **Set values** in the env's values file:
   ...
   ```
4. Validate per the [§ Validation](../../../mi-data/docs/mi-exports.md#4-validation) section of the operator doc.
...
- [`4.6.6-to-4.6.8-upgrade.md`](4.6.6-to-4.6.8-upgrade.md) + [`4.6.8-to-4.7.3-upgrade.md`](4.6.8-to-4.7.3-upgrade.md) — the same upgrade as two smaller hops.
- [`4.6.5-to-4.7.0-values-deltas.md`](4.6.5-to-4.7.0-values-deltas.md) — full table of values to add/change/remove in gemeente `podiumd.yml` for the 4.7.0 jump.
- Granular per-release notes: [4.7.0→4.7.1](4.7.0-to-4.7.1-upgrade.md), [4.7.1→4.7.2](4.7.1-to-4.7.2-upgrade.md), [4.7.2→4.7.3](4.7.2-to-4.7.3-upgrade.md).
