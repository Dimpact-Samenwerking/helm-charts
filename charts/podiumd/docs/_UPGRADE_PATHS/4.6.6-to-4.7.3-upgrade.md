...
Full operator documentation: [`docs/misc/mi-exports.md`](../misc/mi-exports.md).
...
3. **Set values** in the env's values file:
   ...
   ```
4. Validate per the [§ Validation](../misc/mi-exports.md#4-validation) section of the operator doc.
