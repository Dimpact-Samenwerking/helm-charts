...
`docs/_upgrade_paths/upgrade-from-4.7.6-to-4.8.0.md` voor details.
...
image change). See `docs/_upgrade_paths/upgrade-from-4.7.3-to-4.7.4.md`.
...
en CVE-2026-9256). Zie `docs/_upgrade_paths/upgrade-from-4.7.1-to-4.7.2.md` voor details.
