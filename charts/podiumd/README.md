...
### [4.2](https://github.com/Dimpact-Samenwerking/helm-charts/releases/tag/podiumd-4.2)

**PodiumD Helm chart version: 4.2**
...
| openformulieren.tempjobdjango | object | `{"activeDeadlineSeconds":21600,"backoffLimit":3,"bashCommand":"echo this is a test","completions":1,"configMap":{"enabled":false,"name":"","scriptCode":"","scriptMountPath":"/app/bin","scriptName":"custom_script.py"},"enabled":false,"logging":{"enabled":false,"tempjobMountSubpath":""},"parallelism":1,"resources":{},"restartPolicy":"Never","subchartName":"openformulieren","ttlSecondsAfterFinished":0}` |
