...
LEGACY_UPSTREAM: dict[str, str] = {
    ...
    "k8s-wait-for": "ghcr.io/groundnuty/k8s-wait-for",
    ...
    "zaakbrug": "docker.io/wearefrank/zaakbrug",
    "zgw-office-add-in-backend": "ghcr.io/infonl/zgw-office-addin-backend",   # old name -> new canonical url (addin, no hyphen)
    "zgw-office-add-in-frontend": "ghcr.io/infonl/zgw-office-addin-frontend",
    "zgw-office-addin-backend": "ghcr.io/infonl/zgw-office-addin-backend",
    "zgw-office-addin-frontend": "ghcr.io/infonl/zgw-office-addin-frontend",
