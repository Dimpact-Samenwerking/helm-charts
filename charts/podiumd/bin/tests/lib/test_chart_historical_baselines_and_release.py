"""lib.chart — historical images-manifest lookups and release-baseline
writing: historical_images_manifest_paths, historical_app_version_for_
repository, historical_app_version_for_path, write_release_baselines.
Split out of the former test_chart.py (see test_chart_path_and_version_
helpers.py for upgrade_docs_baseline/release_table_baseline reads, and
the other test_chart_*.py files for the rest)."""
