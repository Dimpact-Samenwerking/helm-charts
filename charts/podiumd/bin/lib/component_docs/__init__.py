...
scaffolding (create_missing_docs, STANDARD_SUFFIXES, STUB_TEMPLATES) and
lib.component_docs.images_manifest_changes_header for the images-
manifest "# Changes:" header/item bookkeeping — both split out of this
module, kept as package siblings.
